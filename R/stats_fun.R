...
# theme function
source(here::here("R","custemised_theme.R"))
           ...
           "Word" = {
             summary_table %>%  
               ...
               flextable::save_as_docx(
                 path = here::here("output","result_word.docx"))
           },
           "PDF" = {
             summary_table %>%
               as_gt() %>%
               gtsave(filename = "results.pdf",path = here::here("output"))
           },
           "Excel" = {
             ...
             writexl::write_xlsx(x = gt_table,
                                 path = here::here("output","results_excel.xlsx"),
                                 col_names = TRUE,
                                 format_headers = TRUE,
                                 use_zip64 = FALSE)
           }
